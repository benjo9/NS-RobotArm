...
set(MSG_I_FLAGS "-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg;-Itf:/opt/ros/melodic/share/tf/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Isensor_msgs:/opt/ros/melodic/share/sensor_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/noa/Desktop/Robot_Repo/robot_ws/src/myworkcell_core/srv/LocalizePart.srv" NAME_WE)
add_custom_target(_myworkcell_core_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "myworkcell_core" "/home/noa/Desktop/Robot_Repo/robot_ws/src/myworkcell_core/srv/LocalizePart.srv" "geometry_msgs/Pose:geometry_msgs/Quaternion:geometry_msgs/Point"
)
...
_generate_srv_cpp(myworkcell_core
  "/home/noa/Desktop/Robot_Repo/robot_ws/src/myworkcell_core/srv/LocalizePart.srv"
  "${MSG_I_FLAGS}"
...
if(TARGET tf_generate_messages_cpp)
  add_dependencies(myworkcell_core_generate_messages_cpp tf_generate_messages_cpp)
endif()
...
if(TARGET tf_generate_messages_eus)
  add_dependencies(myworkcell_core_generate_messages_eus tf_generate_messages_eus)
endif()
...
if(TARGET tf_generate_messages_lisp)
  add_dependencies(myworkcell_core_generate_messages_lisp tf_generate_messages_lisp)
endif()
...
if(TARGET tf_generate_messages_nodejs)
  add_dependencies(myworkcell_core_generate_messages_nodejs tf_generate_messages_nodejs)
endif()
...
if(TARGET tf_generate_messages_py)
  add_dependencies(myworkcell_core_generate_messages_py tf_generate_messages_py)
endif()
