...
(cl:defmethod cl:initialize-instance :after ((m <requested_state-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'requested_state-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_control_boilerplate-srv:<requested_state-request> is deprecated: use ros_control_boilerplate-srv:requested_state-request instead.")))

(cl:ensure-generic-function 'axis-val :lambda-list '(m))
(cl:defmethod axis-val ((m <requested_state-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_control_boilerplate-srv:axis-val is deprecated.  Use ros_control_boilerplate-srv:axis instead.")
  (axis m))

(cl:ensure-generic-function 'requested_state-val :lambda-list '(m))
(cl:defmethod requested_state-val ((m <requested_state-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_control_boilerplate-srv:requested_state-val is deprecated.  Use ros_control_boilerplate-srv:requested_state instead.")
  (requested_state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<requested_state-request>)))
  ...
  "ros_control_boilerplate/requested_stateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'requested_state-request)))
  "Returns string type for a service object of type 'requested_state-request"
  "ros_control_boilerplate/requested_stateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <requested_state-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'requested_state-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_control_boilerplate-srv:<requested_state-response> is deprecated: use ros_control_boilerplate-srv:requested_state-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <requested_state-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_control_boilerplate-srv:result-val is deprecated.  Use ros_control_boilerplate-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<requested_state-response>)))
  ...
  "ros_control_boilerplate/requested_stateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'requested_state-response)))
  "Returns string type for a service object of type 'requested_state-response"
  "ros_control_boilerplate/requested_stateResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'requested_state)))
  ...
  "ros_control_boilerplate/requested_state")