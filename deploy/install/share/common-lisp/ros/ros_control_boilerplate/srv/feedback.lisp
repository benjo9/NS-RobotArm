...
(cl:defmethod cl:initialize-instance :after ((m <feedback-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'feedback-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_control_boilerplate-srv:<feedback-request> is deprecated: use ros_control_boilerplate-srv:feedback-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<feedback-request>)))
  ...
  "ros_control_boilerplate/feedbackRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'feedback-request)))
  "Returns string type for a service object of type 'feedback-request"
  "ros_control_boilerplate/feedbackRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <feedback-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'feedback-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_control_boilerplate-srv:<feedback-response> is deprecated: use ros_control_boilerplate-srv:feedback-response instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <feedback-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_control_boilerplate-srv:position-val is deprecated.  Use ros_control_boilerplate-srv:position instead.")
  (position m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<feedback-response>)))
  ...
  "ros_control_boilerplate/feedbackResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'feedback-response)))
  "Returns string type for a service object of type 'feedback-response"
  "ros_control_boilerplate/feedbackResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'feedback)))
  ...
  "ros_control_boilerplate/feedback")