...
(cl:defmethod cl:initialize-instance :after ((m <requested_state-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'requested_state-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name RA_hardware_interface-srv:<requested_state-request> is deprecated: use RA_hardware_interface-srv:requested_state-request instead.")))
...
(cl:defmethod requested_state-val ((m <requested_state-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader RA_hardware_interface-srv:requested_state-val is deprecated.  Use RA_hardware_interface-srv:requested_state instead.")
  (requested_state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<requested_state-request>)))
  ...
  "RA_hardware_interface/requested_stateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'requested_state-request)))
  "Returns string type for a service object of type 'requested_state-request"
  "RA_hardware_interface/requested_stateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <requested_state-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'requested_state-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name RA_hardware_interface-srv:<requested_state-response> is deprecated: use RA_hardware_interface-srv:requested_state-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<requested_state-response>)))
  ...
  "RA_hardware_interface/requested_stateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'requested_state-response)))
  "Returns string type for a service object of type 'requested_state-response"
  "RA_hardware_interface/requested_stateResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'requested_state)))
  ...
  "RA_hardware_interface/requested_state")